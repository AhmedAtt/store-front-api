...
describe('User Model', () => {
    ...
    it('should create a user', async function () {
        ...
        expect(bcrypt.compareSync('test2' + BCRYPT_PASSWORD, result.password)).toBeTruthy();
    });
    it('should return a list of users', async function () {
        ...
        expect(bcrypt.compareSync('test' + BCRYPT_PASSWORD, result[0].password)).toBeTruthy();
    });
    it('should return a user by id', async function () {
        ...
        expect(bcrypt.compareSync('test' + BCRYPT_PASSWORD, result.password)).toBeTruthy();
    });
